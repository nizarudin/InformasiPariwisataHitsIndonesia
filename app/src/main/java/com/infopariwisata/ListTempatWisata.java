...
public class ListTempatWisata extends ListActivity {
	ImageButton back;
	Intent i1;
	...
	public void onCreate(Bundle savedInstanceState) {
		...
		setContentView(R.layout.list_wisata_alam);
		
		
		i1 = new Intent(this, MenuUtamaActivity.class);
		back = (ImageButton) this.findViewById(R.id.backr);
		...
		Cursor cursor = database.bacaWisataAlam();

		startManagingCursor(cursor);
		String[] awal = new String[] { database.FIELD_JUDUL,
				database.FIELD_GAMBAR };
		int[] tujuan = new int[] { R.id.nama3, R.id.gambar3 };
		mCursorAdapter = new SimpleCursorAdapter(this,
				R.layout.item_wisata_alam, cursor, awal, tujuan);
